  ...
  return (
    <div style={{ minHeight: "100vh", background: COLORS.navy, fontFamily: "'DM Sans', sans-serif" }}>
        ...
        >
          {STATS.map((s, i) => (
            ...
            >
              ...
              <div
                style={{ fontSize: 12, color: "rgba(255,255,255,0.45)", marginTop: 4, letterSpacing: "0.3px" }}
              >
                {s.d}
              </div>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
            <div>
              ...
              >
                ...
                wait 3–6 hours in crowded corridors with zero visibility into when they'll be seen —
                called by loudspeaker or not at all.
              </p>
              <button
      ...
      >
        ...
        <p style={{ color: "rgba(255,255,255,0.45)", fontSize: 16, margin: "0 0 36px" }}>
          No hardware. No installation. Just a QR code printout.
        </p>
        <div style={{ display: "flex", gap: 16, justifyContent: "center" }}>
          <button
            onClick={() => setActive("patient")}
