...
const PatientPortalPage = ({ setActive }) => {
  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative", fontFamily: "'DM Sans', sans-serif", paddingTop: 64, overflowX: "hidden" }}>
      ...
      {/* ── 1. BACKGROUND IMAGE LAYER (50% Blur) ── */}
      <div 
        style={{
          position: "fixed",
          top: 0,
      ...
      >
        <div 
          style={{
            position: "absolute",
            inset: 0,
            background: "rgba(10, 25, 47, 0.75)", // Darker tint to help white forms pop
            backdropFilter: "blur(20px)", // 50% Blur (Double the Home blur for a softer look)
      ...
      <div style={{ maxWidth: 580, margin: "0 auto", padding: "48px 24px", position: "relative", zIndex: 1 }}>
        ...
        {/* ── Step 1: Registration Form (Glassmorphism) ── */}
        {step === 1 && (
          <div
            style={{
              background: "rgba(255, 255, 255, 0.95)", // High visibility white
              borderRadius: 24,
              padding: 32,
