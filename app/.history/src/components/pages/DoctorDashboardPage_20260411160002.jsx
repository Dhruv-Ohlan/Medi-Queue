...
const EmergencyModal = ({ onAcknowledge }) => (
  ...
  >
    ...
    >
      ...
      <div style={{ fontSize: 15, color: COLORS.navy, fontWeight: 600, marginBottom: 4 }}>
        GM-42 · Priya Patel · Age 34
      </div>
      <div
        style={{
          fontSize: 14,
    ...
    {Object.keys(QUEUE_DATA).map((dept) => (
      <button
        ...
        style={{
          ...
          fontWeight: 600,
          cursor: "pointer",
          background: active === dept ? COLORS.navy : COLORS.white,
      ...
      >
        ...
        <span
          style={{
            background: active === dept ? "rgba(255,255,255,0.2)" : COLORS.gray100,
            color: active === dept ? COLORS.white : COLORS.gray600,
            borderRadius: 10,
            padding: "2px 7px",
            fontSize: 11,
...
const QueueRow = ({ patient, isLast }) => (
  <div
    style={{
      padding: "16px 20px",
      borderBottom: !isLast ? `1px solid ${COLORS.gray100}` : "none",
      display: "flex",
      alignItems: "center",
      gap: 16,
      background: patient.urgency === "emergency" ? "#FFF8F8" : COLORS.white,
    }}
  >
    {/* Urgency stripe */}
    <div
      style={{
        ...
        height: 48,
        borderRadius: 3,
        background: URGENCY_COLOR[patient.urgency],
        flexShrink: 0,
      }}
    />
    ...
    <div style={{ minWidth: 70 }}>
      ...
      <div style={{ marginTop: 4 }}>
        <Badge type={patient.urgency}>{patient.urgency}</Badge>
      </div>
    </div>
    ...
    {/* Wait time */}
    <div style={{ fontSize: 13, color: COLORS.gray400, minWidth: 60, textAlign: "right" }}>
      {patient.wait}m wait
    </div>
...
const DoctorDashboardPage = () => {
  ...
  return (
    ...
    >
      ...
      {showEmergency && (
        <EmergencyModal onAcknowledge={() => setShowEmergency(false)} />
      )}
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 24px" }}>
        ...
        >
          <div>
            ...
            <p style={{ color: COLORS.gray400, fontSize: 14, margin: "4px 0 0" }}>
              OPD Queue Management · Live
            </p>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div
              style={{ width: 10, height: 10, borderRadius: "50%", background: COLORS.green }}
            />
        ...
        >
          <span style={{ fontSize: 13, color: COLORS.gray600, fontWeight: 600, whiteSpace: "nowrap" }}>
            Department Load
          </span>
          <div
            style={{
          ...
          <span style={{ fontSize: 14, fontWeight: 700, color: loadColor, minWidth: 40 }}>
            {load}%
          </span>
          <span
            style={{
              ...
              padding: "4px 10px",
              borderRadius: 6,
              background: load > 85 ? "#FFEBEE" : load > 60 ? "#FFF3E0" : "#E8F5E9",
              color: loadColor,
            }}
          >
