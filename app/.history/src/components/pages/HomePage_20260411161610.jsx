...
// Ensure home.png is located in your src/assets folder
...
const HomePage = ({ setActive }) => {
  return (
    <div style={{ minHeight: "100vh", backgroundColor: COLORS.navy, fontFamily: "'DM Sans', sans-serif", position: "relative", overflowX: "hidden" }}>
      ...
      {/* ── 1. BACKGROUND IMAGE LAYER (STAYS IN HERO) ── */}
      <div 
        style={{
          position: "absolute",
          top: 0,
      ...
      >
        {/* Overlay for Blur and Gradient Fade into solid Navy */}
        <div 
          style={{
            position: "absolute",
            inset: 0,
            background: `linear-gradient(to bottom, rgba(10, 25, 47, 0.4), ${COLORS.navy})`,
      ...
      {/* ── 2. CONTENT LAYER (Z-INDEX 1 ENSURES VISIBILITY) ── */}
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center" }}>
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                cursor: "pointer",
                boxShadow: "0 10px 25px rgba(0,191,166,0.2)",
              }}
            >
              Get Your Token →
            </button>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 16, lineHeight: 1.8, margin: "0 0 32px" }}>
                  India's government hospitals handle over 50 million OPD visits per month. Patients
                  wait 3–6 hours in crowded corridors with zero visibility.
                </p>
                <button onClick={() => setActive("triage")} style={{ background: "transparent", color: COLORS.teal, border: `1px solid ${COLORS.teal}`, padding: "12px 24px", borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: "pointer" }}>
                  Try AI Triage →
                </button>
              </div>
